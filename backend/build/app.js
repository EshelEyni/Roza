...
const HTMLSanitizerMiddleware_1 = __importDefault(
  require("./middlewares/HTMLSanitizer/HTMLSanitizerMiddleware"),
);
...
if (isProdEnv) {
  app.use(
    express_1.default.static(path_1.default.join(path_1.default.resolve(), "build", "public")),
  );
} else {
  const corsOptions = {
