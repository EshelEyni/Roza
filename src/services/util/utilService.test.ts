...
describe("Util Service", () => {
  ...
  describe("isValidMongoId", () => {
    ...
    it.each(invalidIds)(
      "should return false if id is of type: $type",
      (invalidId) => {
  ...
  describe("validateIds", () => {
    ...
    it("should throw an error if no ID is provided for loggedInUser with a status of 401", () => {
      expect(() =>
        validateIds({ id: undefined, entityName: "loggedInUser" })
      ).toThrow(new AppError("No loggedInUser id provided", 401));
    });

    it("should throw an error if an invalid Mongo ID is provided for an entity with a status of 400", () => {
      expect(() =>
        validateIds({ id: "invalidPostId", entityName: "post" })
    ...
    it("should throw an error if an invalid Mongo ID is provided for loggedInUser with a status of 401", () => {
      expect(() =>
        validateIds({ id: "invalidUserId", entityName: "loggedInUser" })
    ...
    it("should not throw any error if a valid Mongo ID is provided for an entity", () => {
      expect(() =>
        validateIds({ id: validMongoId, entityName: "post" })
      ).not.toThrow();

      expect(() =>
        validateIds({ id: validMongoId, entityName: "loggedInUser" })
      ).not.toThrow();
    });
